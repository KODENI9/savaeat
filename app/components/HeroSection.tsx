        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <span className="text-orange-500 ml-2 inline-block animate-bounce">🍲</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl">
              Savaeat vous aide à trouver les vendeuses de nourriture bien notées et proches de chez vous.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group px-8 py-4 bg-orange-500 text-white font-semibold rounded-xl hover:bg-orange-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden">
              ...
              <button className="group px-8 py-4 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 border-2 border-transparent hover:border-gray-300">
              ...
              <div className="w-80 h-[600px] bg-gradient-to-b from-gray-900 to-gray-800 rounded-[3rem] p-2 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-orange-500 to-orange-600 h-32 flex items-center justify-center relative">
                    ...
                    <div className="absolute top-4 right-4 text-white text-xs font-medium">9:41</div>
                  </div>
                  <div className="p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors duration-300">
                          ...
                          <div className="space-y-2 flex-1">
                            ...
                            <div className="flex space-x-1">
                              {[...Array(5)].map((_, j) => (
                                <div key={j} className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                              ))}
                            </div>
                          </div>
                        </div>
